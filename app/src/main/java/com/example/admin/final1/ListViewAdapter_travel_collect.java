...
public class ListViewAdapter_travel_collect extends ArrayAdapter<Travel> {
    Context context;

    public ListViewAdapter_travel_collect(Context context, List<Travel> items) {
        ...
        itemlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (item.getTitle().equals("鰲峰山觀景平台")){
                    ...
                    Intent intent = new Intent(context, ListView_change_travel_collect.class);
