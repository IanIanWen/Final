...
public class CollectionActivity_food extends AppCompatActivity {

    ListViewAdapter_food_collect adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lvFood = (ListView) findViewById(R.id.list_collect);

        adapter = new ListViewAdapter_food_collect(this, new ArrayList<Food>());
    ...
    private void getTourFromFirebase() {
        ...
        DatabaseReference myRef = database.getReference("collect_food");
