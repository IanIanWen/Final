...
public class ListViewAdapter_food_collect extends ArrayAdapter<Food> {

    Context context;

    public ListViewAdapter_food_collect(Context context, List<Food> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ImageView ivFood = (ImageView) itemlayout.findViewById(R.id.Icon);
        ...
        itemlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (item.getTitle().equals("Mr.Bar風味炭燒")){
                    ...
                    Intent intent = new Intent(context, ListView_change_food_collect.class);
                ...
                if (item.getTitle().equals("櫻桃計畫 cherry espresso")){
                    //start NewActivity with title for actionbar and text for textview
                    Intent intent = new Intent(context, ListView_change_food_collect.class);
